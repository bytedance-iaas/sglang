...
from asym_gemm.testing import get_arch_major
...
def enumerate_m_grouped_contiguous(dtype: torch.dtype) -> Generator:
    for kernel_type in get_kernel_types(dtype):
        for num_groups, expected_m_per_group, n, k in ((4, 8192, 4096, 256), (4, 8192, 7168, 2048), (8, 4096, 4096, 7168), (8, 4096, 7168, 2048)):
