...
class DSV4PoolConfigurator(MemoryPoolConfigurator):
    ...
    def __init__(self, mr: ModelRunner):
        ...
        if envs.SGLANG_OPT_USE_ONLINE_COMPRESS.get():
            ...
            if allow_experimental_online_c128_mtp:
                max_draft_tokens = mr.server_args.max_speculative_num_draft_tokens or 0
                ...
                logger.warning(
                    ...
                    f"(EAGLE topk=1 only, draft_banks={max_draft_tokens}). "
    ...
    def _get_bytes_per_full_token(self) -> float:
        ...
        if c128_online and envs.SGLANG_EXPERIMENTAL_ONLINE_C128_MTP.get():
            c128_state_ratio *= 1 + (
                self.mr.server_args.max_speculative_num_draft_tokens or 0
            )
