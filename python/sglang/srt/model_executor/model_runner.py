...
class ModelRunner:
    ...
    def maybe_init_sidp(self):
        ...
        config = SidpConfig(
            ...
            peak_sync_min_raw_bs=self.server_args.sidp_peak_sync_min_raw_bs,
            peak_sync_max_replays=self.server_args.sidp_peak_sync_max_replays,
            peak_sync_timeout_s=self.server_args.sidp_peak_sync_timeout_s,
