...
class SchedulerBatchResultProcessor:
    ...
    def _maybe_insert_dsv4_decode_radix_prompt(self, req: Req):
        ...
        # bounded to the prefill-committed prompt snapshot so decode deltas never
        # enter the tree.
        ...
        # UnifiedRadixCache materializes leaves from the Full component even when
        # an auxiliary component holds only a tombstone.
