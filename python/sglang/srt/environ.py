...
class Envs:
    ...
    SGLANG_DSPARK_PD_HIDDEN_BUFFER_POOL_LIMIT = EnvInt(16)
    SGLANG_DSPARK_PD_HIDDEN_TRANSFER_QUEUE_LIMIT = EnvInt(0)
    SGLANG_DSPARK_PD_HIDDEN_TRANSFER_QUEUE_BYTES = EnvInt(1024 * 1024 * 1024)
