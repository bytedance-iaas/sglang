...
class Envs:
    ...
    SGLANG_MOONCAKE_TRANSFER_TIMEOUT = EnvFloat(-1)
    SGLANG_MOONCAKE_TRANSFER_ABORT_ON_TIMEOUT = EnvBool(False)
    SGLANG_MOONCAKE_TRANSFER_SLOW_LOG_SECONDS = EnvFloat(10.0)
