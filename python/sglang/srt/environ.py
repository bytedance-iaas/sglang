...
class Envs:
    ...
    SGLANG_DISAGGREGATION_DECODE_OWNER_LEASE = EnvBool(True)
    SGLANG_DISAGGREGATION_OWNER_LEASE_INTERVAL = EnvFloat(30.0)
    SGLANG_DISAGGREGATION_OWNER_LEASE_TIMEOUT = EnvFloat(300.0)
    SGLANG_DISAGGREGATION_OWNER_LEASE_MAX_LIFETIME = EnvFloat(3600.0)
