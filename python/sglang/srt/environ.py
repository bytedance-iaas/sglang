...
class Envs:
    ...
    SGLANG_DG_FP4_MASKED_HINT_MODE = EnvStr("none")
    SGLANG_DG_FP4_MASKED_HINT_MAX = EnvInt(48)
    SGLANG_DG_FP4_MASKED_HINT_ACTIVE = EnvInt(1)
    SGLANG_DG_FP4_MASKED_HINT_MAX_EXPECTED_M = EnvInt(4)
