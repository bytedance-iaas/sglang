...
class Envs:
    ...
    SGLANG_DEBUG_RADIX_PREFIX_HIT = EnvBool(False)
    ...
    SGLANG_JIT_DEEPGEMM_USE_SHARED_PRECOMPILE_MARKER = EnvBool(False)
    SGLANG_JIT_DEEPGEMM_SHARD_PRECOMPILE = EnvBool(False)
    SGLANG_JIT_DEEPGEMM_PRECOMPILE_SHARD_RANK = EnvInt(None)
    SGLANG_JIT_DEEPGEMM_PRECOMPILE_SHARD_SIZE = EnvInt(None)
    SGLANG_JIT_DEEPGEMM_SHOW_PROGRESS = EnvBool(True)
