...
class MRotaryEmbedding(RotaryEmbedding):
    ...
    def _build_axis_map(self) -> Optional[torch.Tensor]:
        ...
        The interleaving pattern depends on mrope_section sizes:
        - GLM-V interleaved-glm (mrope_section=[8,12,12]): round-robin over
          axes, skipping exhausted ones.
        - Interleaved: lanes 0..2 cycle T/H/W, each axis owning every third
          lane up to its section.
        - Standard contiguous (e.g. Qwen3-VL mrope_section=[24,20,20]):
          [0]*s0 + [1]*s1 + [2]*s2.
        """
