...
class Fp8MoEMethod(FusedMoEMethodBase):
    ...
    def create_weights(
        ...
        **extra_weight_attrs,
        ...
        print("Shutian: weight quant action")
        if self.quant_config.is_checkpoint_fp8_serialized:
        ...
        print("Shutian: set the weight using pinned memory")
    ...
    def process_weights_after_loading(self, layer: Module) -> None:
        ...
        print("Shutian: process_weights_after_loading")
    ...
    def create_moe_runner(
        ...
        if moe_runner_backend.is_deep_gemm() or moe_runner_backend.is_triton() or moe_runner_backend.is_asym_comp():
            print("start the self.runner")
