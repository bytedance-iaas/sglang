...
from .fused_moe_asymCompute_config import get_config_dtype_str, try_get_optimal_moe_config
from .fused_moe_asymCompute_kernels import (
...
def inplace_fused_experts(
    ...
    print("within inplace_fused_experts")
    fused_experts_impl(
        hidden_states,
        w1,
        w2,
...
def outplace_fused_experts(
    ...
    print("within outplace_fused_experts")
...
def fused_experts(
    ...
    print("within fused_experts")
    if moe_runner_config.inplace:
        assert not moe_runner_config.no_combine, "no combine + inplace makes no sense"
        print("torch.ops.sglang.inplace_fused_experts")
        ...
        print("torch.ops.sglang.outplace_fused_experts")
...
def fused_experts_impl(
    ...
    print("within fused_experts_impl")
    ...
    for chunk in range((num_tokens // CHUNK_SIZE) + 1):
        ...
        print("invoke_fused_moe_kernel in AsymCompute. Todo: replace it.")
        # TODO: replace this kernel using asymmtric Compute
        invoke_fused_moe_kernel(
            curr_hidden_states,
            w1,
            b1,
