...
def biased_grouped_topk_gpu(
    ...
    if (
        ...
        and (
            is_power_of_two(correction_bias.shape[0]) or correction_bias.shape[0] == 384 or correction_bias.shape[0] == 160
        )  # Kimi K2 has 384 experts and GLM4.6 has 160 experts
    ):
