...
@dataclass
class DeepGemmBf16RunnerInput(RunnerInput):
...
@dataclass
class DeepGemmBf16RunnerOutput(RunnerOutput):
    hidden_states: torch.Tensor
...
@dataclass
class DeepGemmBf16MoeQuantInfo(MoeQuantInfo):
    w13_weight: torch.Tensor
    w2_weight: torch.Tensor


class DeepGemmBf16RunnerCore(MoeRunnerCore):
    ...
    def run(
        self,
        runner_input: DeepGemmBf16RunnerInput,
        quant_info: DeepGemmBf16MoeQuantInfo,
        running_state: dict,
    ) -> DeepGemmBf16RunnerOutput:
        ...
        return DeepGemmBf16RunnerOutput(hidden_states=hidden_states)
