...
if TYPE_CHECKING:
    ...
    from sglang.srt.layers.moe.moe_runner.asym_comp import (
        AsymCompRunnerCore,
        AsymCompRunnerInput,
...
class RunnerInput(ABC):
    ...
    def runner_backend_is_asym_comp(self) -> TypeGuard[AsymCompRunnerInput]:
        return self.runner_backend == MoeRunnerBackend.ASYM_COMP
...
class RunnerOutput(ABC):
    ...
    def runner_backend_is_asym_comp(self) -> TypeGuard[AsymCompRunnerOutput]:
        return self.runner_backend == MoeRunnerBackend.ASYM_COMP
...
class MoeRunnerCore(ABC):
    ...
    def runner_backend_is_asym_comp(self) -> TypeGuard[AsymCompRunnerCore]:
        return self.runner_backend == MoeRunnerBackend.ASYM_COMP
