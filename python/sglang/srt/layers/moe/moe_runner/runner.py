...
from sglang.srt.layers.moe.moe_runner.asym_comp import AsymCompRunnerCore
...
class MoeRunner:
    ...
    def __init__(self, runner_backend: MoeRunnerBackend, config: MoeRunnerConfig):
        ...
        logger.info("initialize MoeRunner")
        if runner_backend.is_triton():
            self.runner_core = TritonRunnerCore(config)
        elif runner_backend.is_asym_comp():
            logger.info("initialize AsymCompRunnerCore")
            self.runner_core = AsymCompRunnerCore(config)
