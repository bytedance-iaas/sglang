...
class NativeSparseAttnBackend(
    ...
    def __init__(
        ...
        mha_nsa_index_topk_value = (
            self.nsa_index_topk * 6
            if self.nsa_kv_cache_store_fp8
            else self.nsa_index_topk * 3
        )
        self.mha_nsa_index_topk = get_int_env_var(
            "SGLANG_MHA_NSA_INDEX_TOPK", mha_nsa_index_topk_value
        )
