...
class HiRadixCache(RadixCache):
    ...
    def drain_storage_control_queues(self):
        """
        Combine prefetch progress, backup ack, and host mem release checks
    ...
    def _handle_prefetch_result(self, operation: PrefetchOperation) -> None:
        ...
        logger.debug(
            "Prefetch %s completed with %d tokens",
            req_id,
            operation.completed_tokens,
        )
    ...
    def _clamp_prefetch_result(
        ...
        """Determine the usable prefix from synchronized completion state.
