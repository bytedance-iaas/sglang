...
class HiSparseUnifiedRadixCache(UnifiedRadixCache):
    ...
    def __init__(self, params: CacheInitParams):
        ...
        self._enable_storage_metrics = params.enable_metrics
        self._attn_cp_group = params.attn_cp_cache_group
        self._attn_tp_group = params.attn_tp_cache_group
    ...
    def init_hisparse_radix_cache(
        ...
        if (
            ...
            if storage_backend is not None:
                storage_extra_config, storage_prefetch_threshold = (
            ...
            self.cache_controller = HybridCacheController(
                ...
                attn_cp_group=self._attn_cp_group,
                attn_tp_group=self._attn_tp_group,
                ...
                enable_storage_metrics=self._enable_storage_metrics,
            )
    ...
    def _parse_storage_backend_extra_config(
        ...
        if storage_backend_extra_config:
            if storage_backend_extra_config.startswith("@"):
                with open(storage_backend_extra_config[1:]) as f:
                    extra_config = json.load(f)
            else:
                extra_config = json.loads(storage_backend_extra_config)

        prefetch_threshold = extra_config.pop("prefetch_threshold", 256)
        return extra_config, prefetch_threshold
