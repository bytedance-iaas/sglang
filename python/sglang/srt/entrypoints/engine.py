...
def _set_envs_and_config(server_args: ServerArgs):
    ...
    if "NCCL_GRAPH_MIXING_SUPPORT" not in os.environ and server_args.dcp_size > 1:
        # NCCL_GRAPH_MIXING_SUPPORT=0 avoids unnecessary EVENT_WAIT and
        # EVENT_RECORD inside cuda graphs. This reduces bubbles when DCP
        # introduces extra collectives during decode.
