...
class CommonKVManager(BaseKVManager):
    ...
    def _mla_slice_ptrs_for_pp(
        ...
        # buffers than ``len(mla_ratios)`` (e.g. nextn padding). C128 state
        # ships as a separate StateType.C128_STATE component and is not counted.
        ...
        sliced_dst = (
            ...
            + list(
                dst_kv_ptrs[
                    compress_section_start + c4_off_s : compress_section_start + c4_off_e
                ]
            )
            + list(
                dst_kv_ptrs[
