        ...
        for i, decode_req in enumerate(self.queue):
            ...
            if use_decode_radix_cache:
                ...
                if self._uses_dsv4_decode_radix_cache():
                    ...
                    # Keep the SWA window entirely in the freshly allocated tail.
                    ...
                    # DSV4 decode radix is intentionally L1-only.
    ...
    def _pre_alloc(
        ...
        if self.scheduler.enable_hisparse:
            ...
            uses_swa_tail = self._uses_swa_tail_prealloc() and (
                prefix_len == 0 or self._uses_dsv4_decode_radix_cache()
            )
            swa_tail_len = self._swa_tail_len(fill_len)
