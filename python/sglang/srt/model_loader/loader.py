...
@contextmanager
def device_loading_context(module: torch.nn.Module, target_device: torch.device, pinned_memory: bool = False):
    ...
    for name, p in module.named_parameters():
        if p.device.type == "cpu":
            print("Shutian: skip the reload parameter from CPU memory to GPU memory during post loading")
            if pinned_memory and name in ("w2_weight", "w13_weight"):
                continue
...
def _initialize_model(
    ...
    print("Shutian: Before quantization")
...
class DefaultModelLoader(BaseModelLoader):
    ...
    def _get_all_weights(
        ...
        print("Shutian: _get_all_weights. Process weight after loading")
    ...
    def load_model(
        ...
        *,
        ...
        with set_default_torch_dtype(model_config.dtype):
            ...
            print("Shutian: After _initialize_model")
    ...
    def load_weights_and_postprocess(model, weights, target_device):
        print("Shutian: start load_weights")
        model.load_weights(weights)
        print("Shutian: finish load_weights")
        for _, module in model.named_modules():
            ...
            if quant_method is not None:
                ...
                with device_loading_context(module, target_device, True):
...
class DummyModelLoader(BaseModelLoader):
    ...
    def load_model(
        ...
        *,
        ...
        print("load_model within DummyModelLoader")
