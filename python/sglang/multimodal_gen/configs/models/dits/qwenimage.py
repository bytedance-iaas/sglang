...
class QwenImageArchConfig(DiTArchConfig):
    ...
    param_names_mapping: dict = field(
        ...
        default_factory=lambda: {
            ...
            r"^(transformer_blocks\.(\d+)\.attn)\.add_q_proj\.(.+)$": (r"\1.to_added_qkv.\3", 0, 3),
            r"^(transformer_blocks\.(\d+)\.attn)\.add_k_proj\.(.+)$": (r"\1.to_added_qkv.\3", 1, 3),
            r"^(transformer_blocks\.(\d+)\.attn)\.add_v_proj\.(.+)$": (r"\1.to_added_qkv.\3", 2, 3),
            # LoRA mappings
