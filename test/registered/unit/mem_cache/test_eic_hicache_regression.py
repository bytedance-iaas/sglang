...
class TestEICHiCacheRegression(unittest.TestCase):
    ...
    def test_free_swa_skips_reserved_page_and_dedups_aliases(self):
        ...
        with mock.patch(
            "sglang.srt.mem_cache.allocator.swa.get_global_server_args",
    ...
    def test_finalize_cross_pp_clamp_keeps_spanning_resident_last_node(self):
        ...
        req.get_fill_ids = lambda _v=list(range(20)): _v
        ...
        req.set_extend_range.assert_called_once_with(10, 20)
    ...
    def test_finalize_partial_load_lands_on_resident_not_evicted_tail(self):
        ...
        req.set_extend_range.assert_called_once_with(14, 20)
    ...
    def _make_req(self, rid, d, hh, load_node_id):
        ...
        req.get_fill_ids = lambda _v=list(range(64)): _v
    ...
    def test_two_stage_load_back_reconciles_span_and_final(self):
        ...
        r0.set_extend_range.assert_called_once_with(12, 64)
        r1.set_extend_range.assert_called_once_with(12, 64)
