...
class TestCPSuffix(HiCacheFileLRUTestBase):
    ...
    def test_shared_cp_storage_is_scoped_by_pp_stage(self):
        stage0_cp0 = self.make_backend(
            is_mla=True,
            use_shared_cp_storage=True,
            pp_rank=0,
            pp_size=2,
        ...
        self.assertEqual(stage0_cp0.config_suffix, stage0_cp3.config_suffix)
        self.assertTrue(stage0_cp0.config_suffix.endswith("_2_0_cpfull_4"))
        self.assertTrue(stage1_cp0.config_suffix.endswith("_2_1_cpfull_4"))
        self.assertNotEqual(stage0_cp0.config_suffix, stage1_cp0.config_suffix)
