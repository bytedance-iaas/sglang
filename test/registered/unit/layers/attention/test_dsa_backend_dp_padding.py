...
class TestDSABackendDPPadding(unittest.TestCase):
    def test_trim_and_restore_eager_decode_dp_padding(self):
        ...
        real_q, real_topk, num_padding_rows = _trim_dsa_dp_padding(
            q_all,
            topk_indices,
            real_batch_size=2,
        )
        ...
        output = _restore_dsa_dp_padding(real_output, num_padding_rows)
    ...
    def test_no_padding_keeps_existing_tensors(self):
        ...
        self.assertIs(
            _restore_dsa_dp_padding(real_q, num_padding_rows),
            real_q,
        )
